...
function ImportTilemap(file, entities) { // eslint-disable-line no-unused-vars
	...
	for (var i = 0; i < file.layers.length; i++) {
		...
		/**
		 * <b>Collidable</b>: True or False <br />Cause this object to have a collision component. Currently collisions are handled as a simulation system in the project.

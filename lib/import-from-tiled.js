...
var setOrAddComponent = require("./set-or-add-component");
 ...
 */
module.exports = function importTilemap(file, entities, images) {
...
function makeTiles(file, z, entities, imageComponents) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var y = ((gridY + 1) * file.tileheight) - image.sourceHeight + (layer.offsety || 0);

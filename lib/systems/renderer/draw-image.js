...
function drawEntity(game, entity, context) {
  ...
  if (!image) {
    console.error(
      ...
      "for entity",
      entity,
      game.entities.getComponent(entity, "name")
    );
    return;
  }
  ...
  if (sw === 0) {
    console.warn(
      "sourceWidth is 0, image would be invisible for entity",
      entity,
      game.entities.getComponent(entity, "name")
    );
  }
  ...
  if (sh === 0) {
    console.warn(
      "sourceHeight is 0, image would be invisible for entity",
      entity,
      game.entities.getComponent(entity, "name")
    );
  }
...
function isOnScreen(game, entity, cameraPosition, cameraSize) {
  ...
  if (dw === 0) {
    console.warn(
      "destinationWidth is 0, image would be invisible for entity",
      entity,
      game.entities.getComponent(entity, "name")
    );
  }
  ...
  if (dh === 0) {
    console.warn(
      "destinationHeight is 0, image would be invisible for entity",
      entity,
      game.entities.getComponent(entity, "name")
    );
  }

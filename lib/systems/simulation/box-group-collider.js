...
module.exports = function(ecs, game) {
  ...
  ecs.add(function boxGroupCollider() {
    ...
    for (i = 0; i < groupsToCollide.length; i++) {
      var a = boxPools[groupsToCollide[i][0]];
      var b = boxPools[groupsToCollide[i][1]];
      if (a && b) {
...
module.exports.collideGroups = function(a, b) {
  groupsToCollide.push([a, b]);
};

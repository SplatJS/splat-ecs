import BoxPool from "../../box-pool";

export default function (ecs, game) {
  game.entities.registerSearch("boxColliderSearch", [
    "position",
    "size",
    "boxCollider",
  ]);

  game.entities.onRemoveComponent(
    "collisions",
    function (entity, component, collisions) {
      for (var i = 0; i < collisions.entities.length; i++) {
        var otherCollisions = game.entities.getComponent(

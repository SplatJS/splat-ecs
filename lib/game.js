...
Game.prototype.makeSceneData = function(entities, sceneArgs) {
	return {
		...
		importPrefabs: this.importPrefabs.bind(this)
	};
};
...
Game.prototype.registerPrefab = function (name,obj){
	var prefabs = this.prefabs;
	prefabs[name] = obj;
};
Game.prototype.importPrefabs = function(library){
	var game = this;
	Object.keys(library).forEach(function(key) {
		game.registerPrefab(key,library[key]);
	});
};

...
Game.prototype.makeSceneData = function(entities, sceneArgs) {
	return {
		...
		importPrefabs: this.registerPrefabs.bind(this)
	};
};
...
Game.prototype.registerPrefab = function (name,component){
	this.prefabs[name] = component;
};
Game.prototype.registerPrefabs = function(obj){
	Object.keys(obj).forEach(function(key) {
		this.registerPrefab(key,obj[key]);
	}.bind(this));
};
